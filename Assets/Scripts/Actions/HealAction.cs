...
public class HealAction : BaseAction
{
    ...
    [SerializeField, Range(1, 100)] private int minHealAmount = 5;
    public void SetMinHealAmount(int value) { minHealAmount = value; }
 
    [SerializeField, Range(1, 100)] private int maxHealAmount = 10;
    public void SetMaxHealAmount(int value) { maxHealAmount = value; }
 
    [SerializeField] private int maxHealDistance = 5;
    public void SetHealRange(int value) { maxHealDistance = value; }
 
    // If true, this unit can also heal itself
    [SerializeField] private bool canHealSelf = true;
    public void SetCanHealSelf(bool value) { canHealSelf = value; }
    ...
    private void Heal()
    {
        OnAnyHeal?.Invoke(this, new OnHealEventArgs
        {
