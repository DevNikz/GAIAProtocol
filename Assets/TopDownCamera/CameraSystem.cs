...
public class CameraSystem : MonoBehaviour {
    ...
    private void Awake()
    {
        followOffset = cinemachineVirtualCamera.GetComponent<CinemachineFollow>().FollowOffset;
    }
    ...
    private void HandleCameraZoom_FieldOfView()
    {
        ...
        float zoomSpeed = 10f;
        cinemachineVirtualCamera.Lens.FieldOfView = Mathf.Lerp(cinemachineVirtualCamera.Lens.FieldOfView, targetFieldOfView, Time.deltaTime * zoomSpeed);       
    ...
    private void HandleCameraZoom_MoveForward()
    {
        ...
        float zoomSpeed = 10f;
        cinemachineVirtualCamera.GetComponent<CinemachineFollow>().FollowOffset =
            Vector3.Lerp(cinemachineVirtualCamera.GetComponent<CinemachineFollow>().FollowOffset, followOffset, Time.deltaTime * zoomSpeed);
